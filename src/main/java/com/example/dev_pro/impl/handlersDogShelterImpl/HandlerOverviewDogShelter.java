...
public class HandlerOverviewDogShelter implements InputMessageHandlerDogShelter {
    ...
    public SendMessage handle(Message message) {
        ...
        SendMessage replyMessage = new SendMessage(chatId, tBotConfig.getOverviewMsgDogShelter());
    ...
    public BotStateDogShelter getHandlerName() {
        return BotStateDogShelter.OVERVIEW_COM;
    }
