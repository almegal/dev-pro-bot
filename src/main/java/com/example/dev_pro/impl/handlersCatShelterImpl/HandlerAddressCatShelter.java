...
public class HandlerAddressCatShelter implements InputMessageHandlerCatShelter {
    ...
    public SendMessage handle(Message message) {
        ...
        SendMessage replyMessage = new SendMessage(chatId, tBotConfig.getAddressMsgCatShelter());
    ...
    public BotStateCatShelter getHandlerName() {
        return BotStateCatShelter.ADDRESS_COM;
    }
}
