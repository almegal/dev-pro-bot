...
public class HandlerInfoCatShelter implements InputMessageHandlerCatShelter {
    ...
    public SendMessage handle(Message message) {
        ...
        SendMessage replyMessage = new SendMessage(chatId, tBotConfig.getInfoMsgCatShelter());
    ...
    public BotStateCatShelter getHandlerName() {
        return BotStateCatShelter.INFO_COM;
    }
