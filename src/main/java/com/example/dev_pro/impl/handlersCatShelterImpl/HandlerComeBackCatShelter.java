...
public class HandlerComeBackCatShelter implements InputMessageHandlerCatShelter {
    ...
    public SendMessage handle(Message message) {
        ...
        SendMessage replyMessage = new SendMessage(chatId, tBotConfig.getComeBackMsgCatShelter());
    ...
    public BotStateCatShelter getHandlerName() {
        return BotStateCatShelter.COME_BACK_COM;
    }
}
