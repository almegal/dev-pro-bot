...
public class ReportTestConstants {
    ...
    public static final Long MOCK_USER_ID_3 = 3L;
    public static final Long MOCK_USER_TELEGRAM_ID_3 = 3L ;
    public static final Long MOCK_USER_CHAT_ID_3 = 3L;
    public static final String MOCK_USER_NICK_NAME_3 = "User nick name 3";
    public static final String MOCK_USER_LAST_NAME_3 = "User last name 3";
    public static final String MOCK_USER_FIRST_NAME_3 = "User first name 3";
    public static final String MOCK_USER_MIDDLE_NAME_3 = "User middle name 3";
    public static final String MOCK_USER_PHONE_NUMBER_3 = "User phone number 3";
    public static final String MOCK_USER_CAR_NUMBER_3 = "User car number 3";
    public static final String MOCK_USER_SHELTER_3 = "User shelter dog";

    public static final TelegramUser MOCK_USER_3 = new TelegramUser(
            MOCK_USER_ID_3,
            MOCK_USER_TELEGRAM_ID_3,
            MOCK_USER_CHAT_ID_3,
            MOCK_USER_NICK_NAME_3,
            MOCK_USER_LAST_NAME_3,
            MOCK_USER_FIRST_NAME_3,
            MOCK_USER_MIDDLE_NAME_3,
            MOCK_USER_PHONE_NUMBER_3,
            MOCK_USER_CAR_NUMBER_3,
            MOCK_USER_SHELTER_3
    );
    ...
    public static final boolean MOCK_ADOPTER_PASSED_PROBATION_PERIOD_1 = false;

    public static final Adopter MOCK_ADOPTER_1 = new Adopter(
            MOCK_ADOPTER_ID_1,
            MOCK_ADOPTER_PASSED_PROBATION_PERIOD_1
    );

    public static final Long MOCK_ADOPTER_ID_2 = 2L;
    public static final boolean MOCK_ADOPTER_PASSED_PROBATION_PERIOD_2 = false;

    public static final Adopter MOCK_ADOPTER_2 = new Adopter(
            MOCK_ADOPTER_ID_2,
            MOCK_ADOPTER_PASSED_PROBATION_PERIOD_2
    );

    public static final Long MOCK_ADOPTER_ID_3 = 3L;
    public static final boolean MOCK_ADOPTER_PASSED_PROBATION_PERIOD_3 = false;

    public static final Adopter MOCK_ADOPTER_3 = new Adopter(
            MOCK_ADOPTER_ID_3,
            MOCK_ADOPTER_PASSED_PROBATION_PERIOD_3
    );
    ...
    public static final Adopter MOCK_REPORT_ADOPTER_1 = MOCK_ADOPTER_1;
    public static final Pet MOCK_REPORT_PET_1 = MOCK_PET_1;
    ...
    public static final Adopter MOCK_REPORT_ADOPTER_2 = MOCK_ADOPTER_2;
    public static final Pet MOCK_REPORT_PET_2 = MOCK_PET_2;
    ...
    public static final Adopter MOCK_REPORT_ADOPTER_3 = MOCK_ADOPTER_3;
    public static final Pet MOCK_REPORT_PET_3 = MOCK_PET_3;
