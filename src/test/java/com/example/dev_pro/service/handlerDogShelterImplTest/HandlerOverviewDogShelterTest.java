...
import com.example.dev_pro.impl.handlersDogShelterImpl.HandlerOverviewDogShelter;
...
public class HandlerOverviewDogShelterTest {
    ...
    @InjectMocks
    private HandlerOverviewDogShelter handler;
    ...
    public void testHandle() {
        ...
        when(tBotConfig.getOverviewMsgDogShelter()).thenReturn(expectedMessage);
    ...
    public void testGetHandlerName() {
        ...
        // Assert
        assertEquals(BotStateDogShelter.OVERVIEW_COM, handlerName);
    }
}