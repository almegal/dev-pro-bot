...
import com.example.dev_pro.impl.handlersDogShelterImpl.HandlerReportComeBackDogShelter;
...
public class HandlerReportComeBackDogShelterTest {
    ...
    @InjectMocks
    private HandlerReportComeBackDogShelter handler;
    ...
    public void testHandle() {
        // Arrange
        String expectedMessage = "You are in the report menu, please select report.";
    ...
    public void testGetHandlerName() {
        ...
        // Assert
        assertEquals(BotStateDogShelter.REPORT_COME_BACK_COM, handlerName);
    }
}