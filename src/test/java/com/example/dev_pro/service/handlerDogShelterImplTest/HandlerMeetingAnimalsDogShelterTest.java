...
import com.example.dev_pro.impl.handlersCatShelterImpl.HandlerMeetingAnimalsCatShelter;
import com.example.dev_pro.impl.handlersDogShelterImpl.HandlerMeetingAnimalsDogShelter;
...
public class HandlerMeetingAnimalsDogShelterTest {
    ...
    @InjectMocks
    private HandlerMeetingAnimalsDogShelter handler;
    ...
    public void testHandle() {
        // Arrange
        String expectedMessage = "Meeting rules for cats.";
        when(telegramBotConfiguration.getMeetingRulesForDog()).thenReturn(expectedMessage);
    ...
    public void testGetHandlerName() {
        ...
        // Assert
        assertEquals(BotStateDogShelter.RULES_FOR_ANIMAL, handlerName);
    }
}