...
import com.example.dev_pro.impl.handlersDogShelterImpl.HandlerSafetyRulesDogShelter;
...
public class HandlerSafetyRulesDogShelterTest {
    ...
    @InjectMocks
    private HandlerSafetyRulesDogShelter handler;
    ...
    public void testHandle() {
        // Arrange
        String expectedMessage = "Safety rules message.";
        when(tBotConfig.getSafetyRulesMsgDogShelter()).thenReturn(expectedMessage);
    ...
    public void testGetHandlerName() {
        ...
        // Assert
        assertEquals(BotStateDogShelter.SAFETY_RULES_COM, handlerName);
    }
}