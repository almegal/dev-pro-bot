...
import com.example.dev_pro.impl.handlersCatShelterImpl.HandlerMainComeBackCatShelter;
import com.example.dev_pro.impl.handlersDogShelterImpl.HandlerMainComeBackDogShelter;
...
public class HandlerMainComeBackDogShelterTest {
    ...
    @InjectMocks
    private HandlerMainComeBackDogShelter handler;
    ...
    public void testHandle() {
        // Arrange
        String expectedMessage = "You have returned to the main menu.";
        when(tBotConfig.getMainComeBackMsg()).thenReturn(expectedMessage);
        when(choosingKeyboardButtons.getKeyboardButtons()).thenReturn(null); // Mock the keyboard buttons if necessary
    ...
    public void testGetHandlerName() {
        ...
        // Assert
        assertEquals(BotStateDogShelter.MAIN_COME_BACK_COM, handlerName);
    }
}