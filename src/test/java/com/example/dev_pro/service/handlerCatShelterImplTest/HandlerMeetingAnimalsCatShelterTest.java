...
public class HandlerMeetingAnimalsCatShelterTest {
    ...
    @InjectMocks
    private HandlerMeetingAnimalsCatShelter handler;
    ...
    public void testHandle() {
        ...
        when(telegramBotConfiguration.getMeetingRulesForCat()).thenReturn(expectedMessage);
    ...
    public void testGetHandlerName() {
        ...
        // Assert
        assertEquals(BotStateCatShelter.RULES_FOR_ANIMAL, handlerName);
    }
}