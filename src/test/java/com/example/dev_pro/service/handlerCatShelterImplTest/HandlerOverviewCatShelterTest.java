...
import com.example.dev_pro.impl.handlersCatShelterImpl.HandlerOverviewCatShelter;
...
public class HandlerOverviewCatShelterTest {
    ...
    @InjectMocks
    private HandlerOverviewCatShelter handler;
    ...
    public void testHandle() {
        // Arrange
        String expectedMessage = "Overview message for cat shelter.";
        when(tBotConfig.getOverviewMsgCatShelter()).thenReturn(expectedMessage);
    ...
    public void testGetHandlerName() {
        ...
        // Assert
        assertEquals(BotStateCatShelter.OVERVIEW_COM, handlerName);
    }
}