...
import com.example.dev_pro.impl.handlersCatShelterImpl.HandlerSafetyRulesCatShelter;
...
public class HandlerSafetyRulesCatShelterTest {
    ...
    @InjectMocks
    private HandlerSafetyRulesCatShelter handler;
    ...
    public void testHandle() {
        ...
        when(tBotConfig.getSafetyRulesMsgCatShelter()).thenReturn(expectedMessage);
    ...
    public void testGetHandlerName() {
        ...
        // Assert
        assertEquals(BotStateCatShelter.SAFETY_RULES_COM, handlerName);
    }
}