...
import com.example.dev_pro.impl.handlersCatShelterImpl.HandlerListDocumentCatShelter;
...
public class HandlerListDocumentCatShelterTest {
    ...
    @InjectMocks
    private HandlerListDocumentCatShelter handler;
    ...
    public void testHandle() {
        // Arrange
        String expectedMessage = "Document for taking animals";
        when(telegramBotConfiguration.getDocumentForTakeAnimals()).thenReturn(expectedMessage);
    ...
    public void testGetHandlerName() {
        ...
        // Assert
        assertEquals(BotStateCatShelter.DOCUMENT_FOR_TAKE_ANIMAL_COM, handlerName);
    }
}